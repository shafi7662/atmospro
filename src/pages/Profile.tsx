  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        {/* 2FA Setup Guide Section (Visible when 2FA is disabled) */}
        {!profile?.two_fa_enabled && (
          <div className={`glass-card rounded-3xl p-7 border border-[var(--blue)]/20 space-y-8 relative overflow-hidden ${!isMobile ? 'rainbow-glow' : ''}`}>
