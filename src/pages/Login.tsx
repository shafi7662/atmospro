    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-transparent relative overflow-hidden">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-white/40 text-[10px] font-black uppercase tracking-[0.4em]">The Ethereal Vault</p>
        </div>
              ...
              >
                <div className="space-y-5">
                  <div className="space-y-2">
                    <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-white/40 px-1">Email Address</label>
                    <div className="relative group">
                      <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#00F0FF] transition-colors text-xl">mail</span>
                      <input
                        type="email"
                        required
                        className="w-full pl-12 pr-4 py-4 rounded-2xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-[#00F0FF] transition-all text-sm"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#00F0FF] transition-colors text-xl">lock</span>
                      <input
                        type={showPassword ? 'text' : 'password'}
                        required
                        className="w-full pl-12 pr-12 py-4 rounded-2xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-[#00F0FF] transition-all text-sm"
                        placeholder="••••••••"
                        value={password}
                ...
                <div className="flex items-center justify-between px-1">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <div className="relative">
                      ...
                      <div className={`w-5 h-5 rounded-lg border transition-all flex items-center justify-center ${
                        rememberMe ? 'bg-[#00F0FF] border-[#00F0FF]' : 'bg-white/5 border-white/10 group-hover:border-white/20'
                      }`}>
                        {rememberMe && <span className="material-symbols-outlined text-black text-sm font-bold">check</span>}
                      </div>
                    </div>
                  ...
                  <button 
                    ...
                    className="text-[9px] font-black uppercase tracking-widest text-[#00F0FF] hover:underline disabled:opacity-50"
                  >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-full bg-[#00F0FF] text-black font-black uppercase tracking-[0.2em] text-xs shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 mt-2 rainbow-glow"
                >
