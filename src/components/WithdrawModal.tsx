...
import { Profile as UserProfile, SystemSettings } from '../types';
...
export const WithdrawModal: React.FC<WithdrawModalProps> = ({ isOpen, onClose, onSuccess, availableBalance }) => {
  ...
  const finalAmount = parseFloat(amount) > 0 ? parseFloat(amount) - withdrawalFee : 0;
                      ...
                      <div className="space-y-1">
                        ...
                        {withdrawalFee > 0 && (
                          <div className="flex justify-between px-1">
                            <span className="text-[8px] font-black text-on-surface-variant uppercase tracking-widest">Fee: ${withdrawalFee}</span>
                            <span className="text-[8px] font-black text-[var(--blue)] uppercase tracking-widest">Receive: ${finalAmount > 0 ? finalAmount : 0}</span>
                          </div>
                        )}
                      </div>
